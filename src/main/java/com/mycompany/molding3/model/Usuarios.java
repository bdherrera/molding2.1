...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.findByIdusarios", query = "SELECT u FROM Usuarios u WHERE u.idusarios = :idusarios"),
...
public class Usuarios implements Serializable {
    ...
    @Column(name = "idusarios")
    private Integer idusarios;
    @Column(name = "cedula")
    ...
    public Usuarios(Integer idusarios) {
        this.idusarios = idusarios;
    }
    ...
    public void setIdusarios(Integer idusarios) {
        this.idusarios = idusarios;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (idusarios != null ? idusarios.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idusarios == null && other.idusarios != null) || (this.idusarios != null && !this.idusarios.equals(other.idusarios))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.mycompany.molding3.model.Usuarios[ idusarios=" + idusarios + " ]";
    }
